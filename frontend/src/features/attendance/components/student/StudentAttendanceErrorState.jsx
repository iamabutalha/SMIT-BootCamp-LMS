...
export function StudentAttendanceErrorState({ onRetry }) {
  return (
    <div className="p-8 text-center bg-white rounded-2xl border border-slate-200 shadow-2xs font-sans max-w-lg mx-auto my-8 space-y-4">
      ...
      <div className="space-y-1">
        <h3 className="text-lg font-bold text-slate-800">Unable to load attendance</h3>
...
export default StudentAttendanceErrorState;
